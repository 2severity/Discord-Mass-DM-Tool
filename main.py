...
os.system("title MassDm - By Severity")
...
def dmspam():
    ...
    async def on_ready():
        ...
        await bot.change_presence(status=discord.Status.online, activity=discord.Activity(type=discord.ActivityType.playing, name="Lithium"))
        ...
        try:
            ...
            if message is not None:
                ...
                fuckembed = discord.Embed(title="FUCKED BY Lithium", description="ĦɆƗŁ Lithium", colour=discord.Colour.red())
                fuckembed.set_thumbnail(url="https://images-ext-1.discordapp.net/external/fOHLWZKLA7hEXYEVKmYmu2192Heb2B6xi2rnp8rqqb4/%3Fsize%3D1024/https/cdn.discordapp.com/banners/1124022195274915881/b261502192f7be5f70e7b88167cb3560.png")
                fuckembed.add_field(name="WHAT IS Lithium?", value="Lithium IS A DISCORD SERVER/ACCOUNT NUKING GROUP​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​   ​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​   ​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​   ", inline=False)
                fuckembed.add_field(name="GG, PRAISE Lithium", value="𝕋ℍ𝕀𝕊 𝔸ℂℂ𝕆𝕌ℕ𝕋 𝔾𝕆𝕋 𝔽𝕌ℂ𝕂𝔼𝔻 𝔹𝕐 Lithium", inline=False)
                fuckembed.add_field(name="𝒟𝐼𝒮𝒞𝒪𝑅𝒟", value="https://discord.gg/TU8F8tYThA", inline=False)
                fuckembed.add_field(name="𝒴𝒪𝒰𝒯𝒰𝐵𝐸", value="https://www.youtube.com/@2severity & https://www.youtube.com/@Dummergoki", inline=False)
                fuckembed.set_footer(text="This DM Spammer is a Open Source Project made by Severity, github: https://github.com/2severity/ | Lithium")
                target = await bot.fetch_user(idofuser)
...
while True:
    ...
    if cmd == "Help" or cmd == "help":
        print(Fore.CYAN + r"""
This is an Discord MassDM Tool Coded by Severity, Here are the Commands:
